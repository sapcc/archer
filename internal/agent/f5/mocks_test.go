...
func (_mock *MockF5Device) DeleteVLAN(name string) error {
	ret := _mock.Called(name)
...
//   - name string
func (_e *MockF5Device_Expecter) DeleteVLAN(name interface{}) *MockF5Device_DeleteVLAN_Call {
	return &MockF5Device_DeleteVLAN_Call{Call: _e.mock.On("DeleteVLAN", name)}
}

func (_c *MockF5Device_DeleteVLAN_Call) Run(run func(name string)) *MockF5Device_DeleteVLAN_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockF5Device_DeleteVLAN_Call) RunAndReturn(run func(name string) error) *MockF5Device_DeleteVLAN_Call {
	_c.Call.Return(run)
	return _c
}
