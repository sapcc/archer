...
type GetRbacPoliciesHandlerFunc func(GetRbacPoliciesParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRbacPoliciesHandlerFunc) Handle(params GetRbacPoliciesParams, principal any) middleware.Responder {
...
type GetRbacPoliciesHandler interface {
	Handle(GetRbacPoliciesParams, any) middleware.Responder
}
...
func NewGetRbacPolicies(ctx *middleware.Context, handler GetRbacPoliciesHandler) *GetRbacPolicies {
	return &GetRbacPolicies{Context: ctx, Handler: handler}
}
...
func (o *GetRbacPolicies) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetRbacPoliciesParams()
