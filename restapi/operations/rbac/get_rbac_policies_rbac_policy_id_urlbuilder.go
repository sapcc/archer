...
func (o *GetRbacPoliciesRbacPolicyIDURL) Build() (*url.URL, error) {
	...
	if rbacPolicyID != "" {
		...
		return nil, errors.New("rbacPolicyId is required on GetRbacPoliciesRbacPolicyIDURL")
	}
...
func (o *GetRbacPoliciesRbacPolicyIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRbacPoliciesRbacPolicyIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRbacPoliciesRbacPolicyIDURL")
	}
