...
func (o *DeleteRbacPoliciesRbacPolicyIDURL) Build() (*url.URL, error) {
	...
	if rbacPolicyID != "" {
		_path = strings.ReplaceAll(_path, "{rbac_policy_id}", rbacPolicyID)
	} else {
		return nil, errors.New("rbacPolicyId is required on DeleteRbacPoliciesRbacPolicyIDURL")
	}
...
func (o *DeleteRbacPoliciesRbacPolicyIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteRbacPoliciesRbacPolicyIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteRbacPoliciesRbacPolicyIDURL")
	}
