...
func (o *PutServiceServiceIDAcceptEndpointsURL) Build() (*url.URL, error) {
	...
	var _path = "/service/{service_id}/accept_endpoints"

	serviceID := o.ServiceID.String()
	if serviceID != "" {
		_path = strings.ReplaceAll(_path, "{service_id}", serviceID)
	} else {
		return nil, errors.New("serviceId is required on PutServiceServiceIDAcceptEndpointsURL")
	}
...
func (o *PutServiceServiceIDAcceptEndpointsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutServiceServiceIDAcceptEndpointsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutServiceServiceIDAcceptEndpointsURL")
	}
