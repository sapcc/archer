...
func (o *PutServiceServiceIDURL) Build() (*url.URL, error) {
	...
	if serviceID != "" {
		...
		return nil, errors.New("serviceId is required on PutServiceServiceIDURL")
	}
...
func (o *PutServiceServiceIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutServiceServiceIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutServiceServiceIDURL")
	}
