...
type PostServiceHandlerFunc func(PostServiceParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn PostServiceHandlerFunc) Handle(params PostServiceParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// PostServiceHandler interface for that can handle valid post service params
type PostServiceHandler interface {
	Handle(PostServiceParams, any) middleware.Responder
}
