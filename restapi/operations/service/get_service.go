...
type GetServiceHandlerFunc func(GetServiceParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn GetServiceHandlerFunc) Handle(params GetServiceParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// GetServiceHandler interface for that can handle valid get service params
type GetServiceHandler interface {
	Handle(GetServiceParams, any) middleware.Responder
}
