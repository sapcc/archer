...
func NewPutServiceServiceIDRejectEndpointsParams() PutServiceServiceIDRejectEndpointsParams {
	...
	return PutServiceServiceIDRejectEndpointsParams{}
}

// PutServiceServiceIDRejectEndpointsParams contains all the bound params for the put service service ID reject endpoints operation
...
func (o *PutServiceServiceIDRejectEndpointsParams) bindServiceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PutServiceServiceIDRejectEndpointsParams) validateServiceID(formats strfmt.Registry) error {
