...
func (o *PutServiceServiceIDRejectEndpointsURL) Build() (*url.URL, error) {
	...
	var _path = "/service/{service_id}/reject_endpoints"

	serviceID := o.ServiceID.String()
	if serviceID != "" {
		_path = strings.ReplaceAll(_path, "{service_id}", serviceID)
	} else {
		return nil, errors.New("serviceId is required on PutServiceServiceIDRejectEndpointsURL")
	}
...
func (o *PutServiceServiceIDRejectEndpointsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutServiceServiceIDRejectEndpointsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutServiceServiceIDRejectEndpointsURL")
	}
