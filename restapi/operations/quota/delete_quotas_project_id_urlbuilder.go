...
func (o *DeleteQuotasProjectIDURL) Build() (*url.URL, error) {
	...
	var _path = "/quotas/{project_id}"

	projectID := o.ProjectID
	if projectID != "" {
		_path = strings.ReplaceAll(_path, "{project_id}", projectID)
	} else {
		return nil, errors.New("projectId is required on DeleteQuotasProjectIDURL")
	}
...
func (o *DeleteQuotasProjectIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteQuotasProjectIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteQuotasProjectIDURL")
	}
