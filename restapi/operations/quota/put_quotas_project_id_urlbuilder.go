...
func (o *PutQuotasProjectIDURL) Build() (*url.URL, error) {
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on PutQuotasProjectIDURL")
	}
...
func (o *PutQuotasProjectIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutQuotasProjectIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutQuotasProjectIDURL")
	}
