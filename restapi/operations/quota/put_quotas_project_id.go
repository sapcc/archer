...
type PutQuotasProjectIDHandlerFunc func(PutQuotasProjectIDParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn PutQuotasProjectIDHandlerFunc) Handle(params PutQuotasProjectIDParams, principal any) middleware.Responder {
...
type PutQuotasProjectIDHandler interface {
	Handle(PutQuotasProjectIDParams, any) middleware.Responder
}
