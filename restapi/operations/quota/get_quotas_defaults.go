...
type GetQuotasDefaultsHandlerFunc func(GetQuotasDefaultsParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn GetQuotasDefaultsHandlerFunc) Handle(params GetQuotasDefaultsParams, principal any) middleware.Responder {
...
type GetQuotasDefaultsHandler interface {
	Handle(GetQuotasDefaultsParams, any) middleware.Responder
}
...
func (o *GetQuotasDefaults) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetQuotasDefaultsParams()
