...
type DeleteQuotasProjectIDHandlerFunc func(DeleteQuotasProjectIDParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteQuotasProjectIDHandlerFunc) Handle(params DeleteQuotasProjectIDParams, principal any) middleware.Responder {
...
type DeleteQuotasProjectIDHandler interface {
	Handle(DeleteQuotasProjectIDParams, any) middleware.Responder
}
