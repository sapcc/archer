...
func (o *GetQuotasProjectIDURL) Build() (*url.URL, error) {
	...
	if projectID != "" {
		...
		return nil, errors.New("projectId is required on GetQuotasProjectIDURL")
	}
...
func (o *GetQuotasProjectIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetQuotasProjectIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetQuotasProjectIDURL")
	}
