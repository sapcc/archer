...
func (o *PutEndpointEndpointIDURL) WithBasePath(bp string) *PutEndpointEndpointIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PutEndpointEndpointIDURL) Build() (*url.URL, error) {
	...
	if endpointID != "" {
		...
		return nil, errors.New("endpointId is required on PutEndpointEndpointIDURL")
	}
...
func (o *PutEndpointEndpointIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutEndpointEndpointIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutEndpointEndpointIDURL")
	}
