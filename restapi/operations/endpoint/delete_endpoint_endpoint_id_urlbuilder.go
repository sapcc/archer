...
func (o *DeleteEndpointEndpointIDURL) WithBasePath(bp string) *DeleteEndpointEndpointIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteEndpointEndpointIDURL) Build() (*url.URL, error) {
	...
	var _path = "/endpoint/{endpoint_id}"

	endpointID := o.EndpointID.String()
	if endpointID != "" {
		_path = strings.ReplaceAll(_path, "{endpoint_id}", endpointID)
	} else {
		return nil, errors.New("endpointId is required on DeleteEndpointEndpointIDURL")
	}
...
func (o *DeleteEndpointEndpointIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteEndpointEndpointIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteEndpointEndpointIDURL")
	}
