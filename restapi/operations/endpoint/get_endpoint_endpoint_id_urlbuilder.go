...
func (o *GetEndpointEndpointIDURL) WithBasePath(bp string) *GetEndpointEndpointIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetEndpointEndpointIDURL) Build() (*url.URL, error) {
	...
	if endpointID != "" {
		...
		return nil, errors.New("endpointId is required on GetEndpointEndpointIDURL")
	}
...
func (o *GetEndpointEndpointIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetEndpointEndpointIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetEndpointEndpointIDURL")
	}
