...
// GetEndpointEndpointIDParams contains all the bound params for the get endpoint endpoint ID operation
...
func (o *GetEndpointEndpointIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetEndpointEndpointIDParams) bindEndpointID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetEndpointEndpointIDParams) validateEndpointID(formats strfmt.Registry) error {
