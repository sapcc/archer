...
type GetEndpointHandlerFunc func(GetEndpointParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn GetEndpointHandlerFunc) Handle(params GetEndpointParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// GetEndpointHandler interface for that can handle valid get endpoint params
type GetEndpointHandler interface {
	Handle(GetEndpointParams, any) middleware.Responder
}
