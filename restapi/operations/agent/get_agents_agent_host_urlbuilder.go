...
func (o *GetAgentsAgentHostURL) Build() (*url.URL, error) {
	...
	var _path = "/agents/{agent_host}"

	agentHost := o.AgentHost
	if agentHost != "" {
		_path = strings.ReplaceAll(_path, "{agent_host}", agentHost)
	} else {
		return nil, errors.New("agentHost is required on GetAgentsAgentHostURL")
	}
...
func (o *GetAgentsAgentHostURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAgentsAgentHostURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAgentsAgentHostURL")
	}
