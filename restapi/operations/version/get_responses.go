...
type GetOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.VersionRoot `json:"body,omitempty"`
}
...
func (o *GetOK) WithPayload(payload *models.VersionRoot) *GetOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get o k response
func (o *GetOK) SetPayload(payload *models.VersionRoot) {
	o.Payload = payload
}
