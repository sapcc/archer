...
func (o *GetQuotasProjectIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 422:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /quotas/{project_id}] GetQuotasProjectID", response, response.Code())
	}
}
...
func (o *GetQuotasProjectIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /quotas/{project_id}][%d] getQuotasProjectIdOK %s", 200, payload)
}
...
func (o *GetQuotasProjectIDUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/{project_id}][%d] getQuotasProjectIdUnauthorized %s", 401, payload)
}
...
func (o *GetQuotasProjectIDUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/{project_id}][%d] getQuotasProjectIdUnprocessableEntity %s", 422, payload)
}
