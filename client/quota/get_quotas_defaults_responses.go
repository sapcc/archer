...
func (o *GetQuotasDefaultsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 422:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /quotas/defaults] GetQuotasDefaults", response, response.Code())
	}
}
...
func (o *GetQuotasDefaultsOK) Error() string {
	...
	return fmt.Sprintf("[GET /quotas/defaults][%d] getQuotasDefaultsOK %s", 200, payload)
}
...
func (o *GetQuotasDefaultsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/defaults][%d] getQuotasDefaultsUnauthorized %s", 401, payload)
}
...
func (o *GetQuotasDefaultsUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/defaults][%d] getQuotasDefaultsUnprocessableEntity %s", 422, payload)
}
