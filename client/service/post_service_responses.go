...
func (o *PostServiceCreated) Error() string {
	...
	return fmt.Sprintf("[POST /service][%d] postServiceCreated %s", 201, payload)
}
...
func (o *PostServiceUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /service][%d] postServiceUnauthorized %s", 401, payload)
}
...
func (o *PostServiceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /service][%d] postServiceForbidden %s", 403, payload)
}
...
func (o *PostServiceConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /service][%d] postServiceConflict %s", 409, payload)
}
...
func (o *PostServiceUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /service][%d] postServiceUnprocessableEntity %s", 422, payload)
}
