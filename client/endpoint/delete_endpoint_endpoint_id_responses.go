...
func (o *DeleteEndpointEndpointIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 422:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /endpoint/{endpoint_id}] DeleteEndpointEndpointID", response, response.Code())
	}
}
...
func (o *DeleteEndpointEndpointIDUnauthorized) Error() string {
	...
	return fmt.Sprintf("[DELETE /endpoint/{endpoint_id}][%d] deleteEndpointEndpointIdUnauthorized %s", 401, payload)
}
...
func (o *DeleteEndpointEndpointIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /endpoint/{endpoint_id}][%d] deleteEndpointEndpointIdForbidden %s", 403, payload)
}
...
func (o *DeleteEndpointEndpointIDUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /endpoint/{endpoint_id}][%d] deleteEndpointEndpointIdUnprocessableEntity %s", 422, payload)
}
