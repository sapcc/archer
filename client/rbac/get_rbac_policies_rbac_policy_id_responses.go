...
func (o *GetRbacPoliciesRbacPolicyIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 422:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /rbac-policies/{rbac_policy_id}] GetRbacPoliciesRbacPolicyID", response, response.Code())
	}
}
...
func (o *GetRbacPoliciesRbacPolicyIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /rbac-policies/{rbac_policy_id}][%d] getRbacPoliciesRbacPolicyIdOK %s", 200, payload)
}
...
func (o *GetRbacPoliciesRbacPolicyIDUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /rbac-policies/{rbac_policy_id}][%d] getRbacPoliciesRbacPolicyIdUnauthorized %s", 401, payload)
}
...
func (o *GetRbacPoliciesRbacPolicyIDNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /rbac-policies/{rbac_policy_id}][%d] getRbacPoliciesRbacPolicyIdNotFound %s", 404, payload)
}
...
func (o *GetRbacPoliciesRbacPolicyIDUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /rbac-policies/{rbac_policy_id}][%d] getRbacPoliciesRbacPolicyIdUnprocessableEntity %s", 422, payload)
}
